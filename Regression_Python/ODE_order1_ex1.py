...
This script is the Python equivalent of ``ODE_order1_ex1.m``.
...
def main() -> None:
    ...
    # tk = 4.1*rand(M,1)-0.05, so tk lies in approximately [-0.05, 4.05].
    ...
    print_run_summary("ODE_order1_ex1", coefficients, solution_rmse)
    ...
    save_or_show_figures(
        ...
        filename_prefix="ODE_order1_ex1",
    )
